...
const NavBar = () => {
  ...
  return (
    ...
    <nav className="py-4 grid grid-cols-2 items-start w-full h-16">
      ...
      <Image src="/logo.png" className="h-16 w-20 hidden md:inline-block lg:hidden" alt="logo" height={80} width={80} />
      ...
      <div className="col-span-1 flex justify-end md:justify-between items-center gap-10">
        <div className="relative w-full lg:w-52 hidden md:block">
          <input
            type="text"
            placeholder="Search by Dua Name"
            className="py-2 px-2 placeholder:text-xs placeholder:text-gray-600 rounded w-full lg:w-52"
          />
