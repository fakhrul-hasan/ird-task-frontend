   ...
   useEffect(()=>{
    ...
    return (
      <>
        ...
        <div onClick={()=>setIsCategory(!isCategory)} className='bg-white rounded-md w-full text-sm p-3 font-medium flex items-center gap-2'><MdMenu /> {categoryData[0]?.cat_name_en}</div>
